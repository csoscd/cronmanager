...
log "       - Paste the contents of docker/docker-compose.yml (host-agent mode)"
log "         or docker/docker-compose-agent.yml (docker-agent mode) into a new Portainer stack"

...
/**
 * Cronmanager Web UI – Password Reset Form Template
 *
 * Variables available:
...
<head>
    ...
    <title><?= $h($t('app_name')) ?> – <?= $h($t('auth_reset_password')) ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md px-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-6"><?= $h($t('auth_reset_password')) ?></h2>
            ...
            <form method="POST" action="/auth/reset">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?= $h($t('auth_new_password')) ?></label>
